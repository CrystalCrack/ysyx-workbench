...
VL_INLINE_OPT void Vlight___024root___nba_sequent__TOP__0(Vlight___024root* vlSelf) {
    ...
    // Init
    IData/*31:0*/ __Vdly__light__DOT__counter;
    __Vdly__light__DOT__counter = 0;
    // Body
        ...
        if ((0x4c4b40U == vlSelf->light__DOT__counter)) {
            vlSelf->led = ((0xfffeU & ((IData)(vlSelf->led) 
                                       << 1U)) | (1U 
                                                  & ((IData)(vlSelf->led) 
                                                     >> 0xfU)));
            __Vdly__light__DOT__counter = 0U;
        } else {
            __Vdly__light__DOT__counter = ((IData)(1U) 
                                           + vlSelf->light__DOT__counter);
        }
    } else {
        vlSelf->led = 1U;
        __Vdly__light__DOT__counter = 0U;
    }
    vlSelf->light__DOT__counter = __Vdly__light__DOT__counter;
}
...
#endif
                    VL_FATAL_MT("/home/crystc/ysyx-workbench/npc/vsrc/light.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/crystc/ysyx-workbench/npc/vsrc/light.v", 1, "", "NBA region did not converge.");
            }
