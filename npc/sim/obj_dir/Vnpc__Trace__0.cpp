...
void Vnpc___024root__trace_chg_sub_0(Vnpc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgBit(oldp+159,(vlSelf->npc__DOT__idu_inst__DOT__ebreak));
        bufp->chgBit(oldp+160,(vlSelf->npc__DOT__rst_d));
        bufp->chgBit(oldp+161,(vlSelf->npc__DOT__validW_d));
        ...
        bufp->chgBit(oldp+480,(vlSelf->npc__DOT__u_IFU__DOT__state));
