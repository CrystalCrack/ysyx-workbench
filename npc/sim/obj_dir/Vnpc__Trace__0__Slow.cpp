...
VL_ATTR_COLD void Vnpc___024root__trace_init_sub__TOP__0(Vnpc___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+147,"rs2", false,-1, 4,0);
    tracep->declBus(c+148,"rd", false,-1, 4,0);
    tracep->declBus(c+30,"imm", false,-1, 31,0);
    tracep->declBus(c+149,"funct3", false,-1, 2,0);
    ...
    tracep->declBus(c+50,"rf_wdata", false,-1, 31,0);
    tracep->declBus(c+51,"rf_rdata1", false,-1, 31,0);
    tracep->declBus(c+152,"rf_rdata2", false,-1, 31,0);
    tracep->declBus(c+29,"rf_raddr1", false,-1, 4,0);
    tracep->declBus(c+147,"rf_raddr2", false,-1, 4,0);
    tracep->declBus(c+52,"ALU_result", false,-1, 31,0);
    tracep->declBus(c+51,"ALU_A", false,-1, 31,0);
    tracep->declBus(c+53,"ALU_B", false,-1, 31,0);
    tracep->declBit(c+163,"ALU_Cin", false,-1);
    tracep->declBit(c+54,"ALU_zero", false,-1);
    tracep->declBit(c+55,"ALU_overflow", false,-1);
    tracep->declBit(c+56,"ALU_Cout", false,-1);
    tracep->declBit(c+34,"stop_sim", false,-1);
    ...
    tracep->declBit(c+33,"ALUsrc2", false,-1);
    tracep->declBit(c+34,"stop_sim", false,-1);
    tracep->declBus(c+35,"inst_name", false,-1, 1,0);
    ...
    tracep->declBus(c+36,"lut_out", false,-1, 2,0);
    ...
    tracep->declBus(c+38,"lut_out", false,-1, 0,0);
    ...
    for (int i = 0; i < 2; ++i) {
        tracep->declQuad(c+40+i*2,"pair_list", true,(i+0), 33,0);
    }
    for (int i = 0; i < 2; ++i) {
    ...
    tracep->declBus(c+48,"lut_out", false,-1, 0,0);
    ...
    tracep->declBit(c+57,"add_overflow", false,-1);
    tracep->declBit(c+58,"sub_overflow", false,-1);
    tracep->declBit(c+59,"int_Cout", false,-1);
    tracep->declBus(c+60,"add_result", false,-1, 31,0);
    tracep->declBus(c+61,"sub_result", false,-1, 31,0);
    tracep->declQuad(c+62,"out", false,-1, 33,0);
    ...
    tracep->declBit(c+65,"Cout", false,-1);
    tracep->declBit(c+58,"overflow", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declArray(c+66,"lut", false,-1, 295,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+178,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+166,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+176,"DATA_LEN", false,-1, 31,0);
    ...
    for (int i = 0; i < 8; ++i) {
        tracep->declQuad(c+76+i*2,"pair_list", true,(i+0), 36,0);
    }
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+21+i*1,"key_list", true,(i+0), 2,0);
    }
    for (int i = 0; i < 8; ++i) {
        tracep->declQuad(c+92+i*2,"data_list", true,(i+0), 33,0);
    }
    tracep->declQuad(c+108,"lut_out", false,-1, 33,0);
    ...
    tracep->declBus(c+148,"waddr", false,-1, 4,0);
    tracep->declBit(c+172,"wen", false,-1);
    tracep->declBus(c+29,"raddr1", false,-1, 4,0);
    tracep->declBus(c+147,"raddr2", false,-1, 4,0);
    tracep->declBus(c+51,"rdata1", false,-1, 31,0);
    tracep->declBus(c+152,"rdata2", false,-1, 31,0);
...
VL_ATTR_COLD void Vnpc___024root__trace_full_sub_0(Vnpc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+34,(vlSelf->npc__DOT__stop_sim));
    bufp->fullCData(oldp+35,(vlSelf->npc__DOT__idu_inst__DOT__inst_name),2);
    bufp->fullCData(oldp+36,(vlSelf->npc__DOT__idu_inst__DOT__getALU_mode__DOT__i0__DOT__lut_out),3);
    bufp->fullBit(oldp+37,(vlSelf->npc__DOT__idu_inst__DOT__getALU_mode__DOT__i0__DOT__hit));
    bufp->fullBit(oldp+38,(vlSelf->npc__DOT__idu_inst__DOT__getALUsrc2__DOT__i0__DOT__lut_out));
    bufp->fullBit(oldp+39,(vlSelf->npc__DOT__idu_inst__DOT__getALUsrc2__DOT__i0__DOT__hit));
    bufp->fullQData(oldp+40,(vlSelf->npc__DOT__idu_inst__DOT__getimm__DOT__i0__DOT__pair_list[0]),34);
    bufp->fullQData(oldp+42,(vlSelf->npc__DOT__idu_inst__DOT__getimm__DOT__i0__DOT__pair_list[1]),34);
    bufp->fullIData(oldp+44,(vlSelf->npc__DOT__idu_inst__DOT__getimm__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+45,(vlSelf->npc__DOT__idu_inst__DOT__getimm__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+46,(vlSelf->npc__DOT__idu_inst__DOT__getimm__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+47,(vlSelf->npc__DOT__idu_inst__DOT__getimm__DOT__i0__DOT__hit));
    bufp->fullBit(oldp+48,(vlSelf->npc__DOT__idu_inst__DOT__getmemtoreg__DOT__i0__DOT__lut_out));
    bufp->fullBit(oldp+49,(vlSelf->npc__DOT__idu_inst__DOT__getmemtoreg__DOT__i0__DOT__hit));
    bufp->fullIData(oldp+50,(((IData)(vlSelf->npc__DOT__memtoreg)
                               ? 0U : (IData)(vlSelf->npc__DOT__u_ALU__DOT__out))),32);
    bufp->fullIData(oldp+51,(vlSelf->npc__DOT__rf_rdata1),32);
    bufp->fullIData(oldp+52,((IData)(vlSelf->npc__DOT__u_ALU__DOT__out)),32);
    bufp->fullIData(oldp+53,(vlSelf->npc__DOT__ALU_B),32);
    bufp->fullBit(oldp+54,((1U & (~ (IData)((0U != (IData)(vlSelf->npc__DOT__u_ALU__DOT__out)))))));
    bufp->fullBit(oldp+55,((1U & (IData)((vlSelf->npc__DOT__u_ALU__DOT__out 
                                          >> 0x20U)))));
    bufp->fullBit(oldp+56,((1U & (IData)((vlSelf->npc__DOT__u_ALU__DOT__out 
                                          >> 0x21U)))));
    bufp->fullBit(oldp+57,(vlSelf->npc__DOT__u_ALU__DOT__add_overflow));
    bufp->fullBit(oldp+58,(vlSelf->npc__DOT__u_ALU__DOT__sub_overflow));
    bufp->fullBit(oldp+59,(vlSelf->npc__DOT__u_ALU__DOT__int_Cout));
    bufp->fullIData(oldp+60,(vlSelf->npc__DOT__u_ALU__DOT__add_result),32);
    bufp->fullIData(oldp+61,(vlSelf->npc__DOT__u_ALU__DOT__sub_result),32);
    bufp->fullQData(oldp+62,(vlSelf->npc__DOT__u_ALU__DOT__out),34);
    bufp->fullIData(oldp+64,((~ vlSelf->npc__DOT__ALU_B)),32);
    bufp->fullBit(oldp+65,((1U & (IData)((1ULL & ((1ULL 
                                                   + 
    ...
    __Vtemp_ha4f0cf77__0[5U] = (0xc00000U | ((vlSelf->__VdfgTmp_h2cfea135__0 
                                             ...
                                             | (vlSelf->__VdfgTmp_h9821ef23__0 
                                                >> 0xcU)));
    __Vtemp_ha4f0cf77__0[6U] = (0x10000000U | ((vlSelf->npc__DOT__u_ALU__DOT__sub_result 
                                                << 0x1eU) 
    ...
    __Vtemp_ha4f0cf77__0[9U] = (((IData)(vlSelf->npc__DOT__u_ALU__DOT__int_Cout) 
                                 << 4U) | (((IData)(vlSelf->npc__DOT__u_ALU__DOT__add_overflow) 
                                           ...
                                           | (vlSelf->npc__DOT__u_ALU__DOT__add_result 
                                              >> 0x1dU)));
    bufp->fullWData(oldp+66,(__Vtemp_ha4f0cf77__0),296);
    bufp->fullQData(oldp+76,(vlSelf->npc__DOT__u_ALU__DOT__u_MuxKeyWithDefault__DOT__i0__DOT__pair_list[0]),37);
    bufp->fullQData(oldp+78,(vlSelf->npc__DOT__u_ALU__DOT__u_MuxKeyWithDefault__DOT__i0__DOT__pair_list[1]),37);
    bufp->fullQData(oldp+80,(vlSelf->npc__DOT__u_ALU__DOT__u_MuxKeyWithDefault__DOT__i0__DOT__pair_list[2]),37);
    bufp->fullQData(oldp+82,(vlSelf->npc__DOT__u_ALU__DOT__u_MuxKeyWithDefault__DOT__i0__DOT__pair_list[3]),37);
    bufp->fullQData(oldp+84,(vlSelf->npc__DOT__u_ALU__DOT__u_MuxKeyWithDefault__DOT__i0__DOT__pair_list[4]),37);
    bufp->fullQData(oldp+86,(vlSelf->npc__DOT__u_ALU__DOT__u_MuxKeyWithDefault__DOT__i0__DOT__pair_list[5]),37);
    bufp->fullQData(oldp+88,(vlSelf->npc__DOT__u_ALU__DOT__u_MuxKeyWithDefault__DOT__i0__DOT__pair_list[6]),37);
    bufp->fullQData(oldp+90,(vlSelf->npc__DOT__u_ALU__DOT__u_MuxKeyWithDefault__DOT__i0__DOT__pair_list[7]),37);
    bufp->fullQData(oldp+92,(vlSelf->npc__DOT__u_ALU__DOT__u_MuxKeyWithDefault__DOT__i0__DOT__data_list[0]),34);
    bufp->fullQData(oldp+94,(vlSelf->npc__DOT__u_ALU__DOT__u_MuxKeyWithDefault__DOT__i0__DOT__data_list[1]),34);
    bufp->fullQData(oldp+96,(vlSelf->npc__DOT__u_ALU__DOT__u_MuxKeyWithDefault__DOT__i0__DOT__data_list[2]),34);
    bufp->fullQData(oldp+98,(vlSelf->npc__DOT__u_ALU__DOT__u_MuxKeyWithDefault__DOT__i0__DOT__data_list[3]),34);
    bufp->fullQData(oldp+100,(vlSelf->npc__DOT__u_ALU__DOT__u_MuxKeyWithDefault__DOT__i0__DOT__data_list[4]),34);
    bufp->fullQData(oldp+102,(vlSelf->npc__DOT__u_ALU__DOT__u_MuxKeyWithDefault__DOT__i0__DOT__data_list[5]),34);
    bufp->fullQData(oldp+104,(vlSelf->npc__DOT__u_ALU__DOT__u_MuxKeyWithDefault__DOT__i0__DOT__data_list[6]),34);
    bufp->fullQData(oldp+106,(vlSelf->npc__DOT__u_ALU__DOT__u_MuxKeyWithDefault__DOT__i0__DOT__data_list[7]),34);
    bufp->fullQData(oldp+108,(vlSelf->npc__DOT__u_ALU__DOT__u_MuxKeyWithDefault__DOT__i0__DOT__lut_out),34);
    bufp->fullBit(oldp+110,(vlSelf->npc__DOT__u_ALU__DOT__u_MuxKeyWithDefault__DOT__i0__DOT__hit));
    bufp->fullIData(oldp+111,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[0]),32);
    bufp->fullIData(oldp+112,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[1]),32);
    bufp->fullIData(oldp+113,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[2]),32);
    bufp->fullIData(oldp+114,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[3]),32);
    bufp->fullIData(oldp+115,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[4]),32);
    bufp->fullIData(oldp+116,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[5]),32);
    bufp->fullIData(oldp+117,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[6]),32);
    bufp->fullIData(oldp+118,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[7]),32);
    bufp->fullIData(oldp+119,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[8]),32);
    bufp->fullIData(oldp+120,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[9]),32);
    bufp->fullIData(oldp+121,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[10]),32);
    bufp->fullIData(oldp+122,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[11]),32);
    bufp->fullIData(oldp+123,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[12]),32);
    bufp->fullIData(oldp+124,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[13]),32);
    bufp->fullIData(oldp+125,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[14]),32);
    bufp->fullIData(oldp+126,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[15]),32);
    bufp->fullIData(oldp+127,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[16]),32);
    bufp->fullIData(oldp+128,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[17]),32);
    bufp->fullIData(oldp+129,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[18]),32);
    bufp->fullIData(oldp+130,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[19]),32);
    bufp->fullIData(oldp+131,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[20]),32);
    bufp->fullIData(oldp+132,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[21]),32);
    bufp->fullIData(oldp+133,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[22]),32);
    bufp->fullIData(oldp+134,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[23]),32);
    bufp->fullIData(oldp+135,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[24]),32);
    bufp->fullIData(oldp+136,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[25]),32);
    bufp->fullIData(oldp+137,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[26]),32);
    bufp->fullIData(oldp+138,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[27]),32);
    bufp->fullIData(oldp+139,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[28]),32);
    bufp->fullIData(oldp+140,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[29]),32);
    bufp->fullIData(oldp+141,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[30]),32);
    bufp->fullIData(oldp+142,(vlSelf->npc__DOT__u_RegisterFile__DOT__rf[31]),32);
    bufp->fullBit(oldp+143,(vlSelf->clk));
    bufp->fullBit(oldp+144,(vlSelf->rst));
    bufp->fullIData(oldp+145,(vlSelf->pc),32);
    bufp->fullIData(oldp+146,(vlSelf->inst),32);
    bufp->fullCData(oldp+147,((0x1fU & (vlSelf->inst 
                                        >> 0x14U))),5);
    bufp->fullCData(oldp+148,(((IData)(vlSelf->npc__DOT__stop_sim)
                                ? 0xaU : (0x1fU & (vlSelf->inst 
                                                   >> 7U)))),5);
    bufp->fullCData(oldp+149,((7U & (vlSelf->inst >> 0xcU))),3);
    bufp->fullCData(oldp+150,((vlSelf->inst >> 0x19U)),7);
    bufp->fullCData(oldp+151,((0x7fU & vlSelf->inst)),7);
    bufp->fullIData(oldp+152,(((0U == (0x1fU & (vlSelf->inst 
                                                >> 0x14U)))
