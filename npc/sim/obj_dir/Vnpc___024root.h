...
class Vnpc___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ npc__DOT__idu_inst__DOT__inst_name;
    ...
    VlUnpacked<QData/*32:0*/, 1> npc__DOT__idu_inst__DOT__getimm__DOT__i0__DOT__pair_list;
    VlUnpacked<CData/*0:0*/, 1> npc__DOT__idu_inst__DOT__getimm__DOT__i0__DOT__key_list;
    VlUnpacked<IData/*31:0*/, 1> npc__DOT__idu_inst__DOT__getimm__DOT__i0__DOT__data_list;
    VlUnpacked<CData/*3:0*/, 1> npc__DOT__idu_inst__DOT__getALU_mode__DOT__i0__DOT__pair_list;
    VlUnpacked<CData/*0:0*/, 1> npc__DOT__idu_inst__DOT__getALU_mode__DOT__i0__DOT__key_list;
    VlUnpacked<CData/*2:0*/, 1> npc__DOT__idu_inst__DOT__getALU_mode__DOT__i0__DOT__data_list;
    VlUnpacked<CData/*1:0*/, 1> npc__DOT__idu_inst__DOT__getmemtoreg__DOT__i0__DOT__pair_list;
    VlUnpacked<CData/*0:0*/, 1> npc__DOT__idu_inst__DOT__getmemtoreg__DOT__i0__DOT__key_list;
    VlUnpacked<CData/*0:0*/, 1> npc__DOT__idu_inst__DOT__getmemtoreg__DOT__i0__DOT__data_list;
    VlUnpacked<CData/*1:0*/, 1> npc__DOT__idu_inst__DOT__getALUsrc2__DOT__i0__DOT__pair_list;
    VlUnpacked<CData/*0:0*/, 1> npc__DOT__idu_inst__DOT__getALUsrc2__DOT__i0__DOT__key_list;
    VlUnpacked<CData/*0:0*/, 1> npc__DOT__idu_inst__DOT__getALUsrc2__DOT__i0__DOT__data_list;
