...
class Vnpc___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*1:0*/ npc__DOT__idu_inst__DOT____Vcellinp__get_ALUsrc2__key;
    ...
    struct {
        ...
        VlUnpacked<CData/*3:0*/, 2> npc__DOT__idu_inst__DOT__get_ALUsrc2__DOT__i0__DOT__pair_list;
        VlUnpacked<CData/*1:0*/, 2> npc__DOT__idu_inst__DOT__get_ALUsrc2__DOT__i0__DOT__key_list;
        VlUnpacked<CData/*1:0*/, 2> npc__DOT__idu_inst__DOT__get_ALUsrc2__DOT__i0__DOT__data_list;
