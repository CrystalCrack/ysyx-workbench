...
VL_ATTR_COLD void Vnpc___024root__trace_init_sub__TOP__0(Vnpc___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+124,"ALU_Cin", false,-1);
    tracep->declBit(c+18,"ALU_zero", false,-1);
    tracep->declBit(c+19,"ALU_overflow", false,-1);
    tracep->declBit(c+20,"ALU_Cout", false,-1);
    tracep->declBit(c+118,"stop_sim", false,-1);
    tracep->declBit(c+125,"stop_simulation", false,-1);
    ...
    tracep->declBit(c+126,"Cin", false,-1);
    ...
    tracep->declBus(c+127,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+128,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+129,"DATA_LEN", false,-1, 31,0);
    tracep->declQuad(c+26,"out", false,-1, 33,0);
    tracep->declBus(c+11,"key", false,-1, 2,0);
    tracep->declQuad(c+130,"default_out", false,-1, 33,0);
    ...
    tracep->declBus(c+136,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBit(c+107,"clk", false,-1);
    ...
    tracep->declBit(c+126,"ren", false,-1);
    for (int i = 0; i < 32; ++i) {
...
VL_ATTR_COLD void Vnpc___024root__trace_full_sub_0(Vnpc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    __Vtemp_h47329a61__0[9U] = (((IData)(vlSelf->npc__DOT__u_ALU__DOT__int_Cout) 
                                 << 4U) | (((IData)(vlSelf->npc__DOT__u_ALU__DOT__add_overflow) 
                                           ...
                                           | (vlSelf->npc__DOT__u_ALU__DOT__add_result 
                                              >> 0x1dU)));
    bufp->fullWData(oldp+30,(__Vtemp_h47329a61__0),296);
    ...
    bufp->fullIData(oldp+117,(((0U == (0x1fU & (vlSelf->inst 
                               ...
                               [(0x1fU & (vlSelf->inst 
                                          >> 0x14U))])),32);
    bufp->fullBit(oldp+118,((0x100073U == vlSelf->inst)));
    bufp->fullIData(oldp+119,((((- (IData)((vlSelf->inst 
                                            >> 0x1fU))) 
                                << 0xcU) | (vlSelf->inst 
                                            >> 0x14U))),32);
    bufp->fullIData(oldp+120,((0xfffff000U & vlSelf->inst)),32);
    ...
    bufp->fullIData(oldp+128,(3U),32);
    bufp->fullIData(oldp+129,(0x22U),32);
    bufp->fullQData(oldp+130,(0ULL),34);
    bufp->fullIData(oldp+132,(1U),32);
    bufp->fullIData(oldp+133,(0x25U),32);
